...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`w-[280px] bg-[#0a0a0a] border-b border-r mr-[20px] border-[#333333] flex flex-col h-[calc(100vh-5rem)] transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 overflow-y-auto `}
      >
        <div className="flex-grow px-4 py-8 space-y-8">
            ...
            <nav className="space-y-2">
              {menuItems.map(item => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-5 h-5 flex items-center justify-center ${isActive ? 'text-[#FF5C35]' : 'text-gray-500'}`}
                    >
                      {item.icon === 'grid' && (
                        <svg
                          width="18"
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link
                to="#"
                className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-sm text-gray-400 border border-transparent hover:text-white hover:bg-[#1a1a1a] hover:border-[#333333]"
              >
                <svg
                  width="18"
                  height="18"
